...
namespace DeleteEmptyWav.Cmd
{
    class Options
    {
        ...
        [Option('m', "measure", Required = false, HelpText = "Measure the emptyness as a percentange of the file.", Default = false)]
        public bool Measure { get; set; }

        [Option('t', "threshold", Required = false, HelpText = "Noise floor threshold (between 0 and 1).", Default = 0.001F)]
        public float Threshold { get; set; }

        [Option('d', "delete", Required = false, HelpText = "Move empty files to the recycle bin.", Default = false)]
